...
import net.pl3x.bukkit.shutdownnotice.api.chat.ClickEvent;
import net.pl3x.bukkit.shutdownnotice.api.chat.HoverEvent;
...
public class BaseComponentSerializer
{
  protected void deserialize(JsonObject object, BaseComponent component, JsonDeserializationContext context)
  {
    ...
    if (object.has("extra"))
    {
      component.setExtra(java.util.Arrays.asList(context.deserialize(object.get("extra"), BaseComponent[].class)));
    }
