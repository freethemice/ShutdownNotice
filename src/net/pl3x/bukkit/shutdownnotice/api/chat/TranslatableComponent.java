...
import net.pl3x.bukkit.shutdownnotice.api.ChatColor;
  ...
  extends BaseComponent
{
  ...
  public String toString() { return "TranslatableComponent(locales=" + getLocales() + ", format=" + getFormat() + ", translate=" + getTranslate() + ", with=" + getWith() + ")"; }
  



  public ResourceBundle getLocales() { return this.locales; } private final ResourceBundle locales = ResourceBundle.getBundle("mojang-translations/en_US");
  public Pattern getFormat() { return this.format; } private final Pattern format = Pattern.compile("%(?:(\\d+)\\$)?([A-Za-z%]|$)");
