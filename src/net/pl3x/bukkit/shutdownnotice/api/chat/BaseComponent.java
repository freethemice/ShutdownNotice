...
public abstract class BaseComponent {
  ...
  private java.util.List<BaseComponent> extra;
  ...
  public java.util.List<BaseComponent> getExtra()
  {
    return this.extra;
  }
  ...
  public void addExtra(BaseComponent component)
  {
    if (this.extra == null)
    {
      this.extra = new java.util.ArrayList();
    }
    component.parent = this;
